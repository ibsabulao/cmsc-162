...
namespace Image_Processing
{
    public partial class Form1 : Form
    {
        ...
        private void GammaTransform_Click(object sender, EventArgs e)
        {
            ...
            {
                //maxFrequency.Text = null;  // remove color channel related text
                imageLabel.Text = "Gamma Transformation";
        ...
        {
            double saltProbability = double.Parse(this.saltProb.Text); // Set the probability of salt noise, e.g., 5%
            double pepperProbability = double.Parse(this.pepperProb.Text); // Set the probability of pepper noise, e.g., 8%
